module.exports = {
    ...
    headerTemplate: "<div style='margin:30px 60px 0; width: 100%; font-size: 11px; border-bottom: solid lightgray 1px;'> GPStar Proton Pack & Neutrona Wand Operation Guide </div>",
