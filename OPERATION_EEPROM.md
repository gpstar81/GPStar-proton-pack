...
| 3 | Mode Original Toggle Switch Sounds / VGA&nbsp;Colour&nbsp;Mode&nbsp;Toggles | Enable/Disable the toggle switch sound effects for the mode original system mode. | Cycle through VG color modes.<sup>5</sup> |
