...
All firmware files for the audio controllers can be found in the [extras/sound/](extras/sound/) folder. Files are grouped by their device name, and a firmware update tool for the GPStar Audio firmware is available for ease of flashing that device.
