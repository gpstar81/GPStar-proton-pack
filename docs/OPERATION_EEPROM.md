...
| 3️⃣ | Wand&nbsp;Beep&nbsp;Loop&nbsp;/ Barrel&nbsp;Switch&nbsp;Polarity&nbsp;Toggle | Enable/Disable the looping beep sound effect in Afterlife and Frozen Empire Mode. | Toggle the polarity for the barrel safety switch between **Default** (barrel extended when switch OFF), **Inverted** (barrel extended when switch ON), and **Disabled**. |
