...
| 4️⃣ | Firing&nbsp;Mode&nbsp;Selection&nbsp;/ Spectral&nbsp;Modes | Cycle through VG/CTS operation modes to set as your default.<sup>1</sup> | Enable/Disable the Spectral Modes. <br><br>📝 `VG operation mode only` |
...
| 3️⃣ | Wand&nbsp;Beep&nbsp;Loop&nbsp;/ Barrel&nbsp;Switch&nbsp;Polarity&nbsp;Toggle | Enable/Disable the looping beep sound effect in Afterlife and Frozen Empire Mode. | Toggle the polarity for the barrel position detection switch between **Default** (barrel extended when switch OFF), **Inverted** (barrel extended when switch ON), and **Disabled**. |
