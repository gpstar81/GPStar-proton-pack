...
| <span class="logo-icon-tiny"></span> GPStar Single-shot Blaster | No | No | No | No | Yes | Yes |
...
| <sup>s1</sup> Wireless Adapter (ESP32)  | No | No | Yes | Yes | Yes | Yes |
| Belt Gizmo | No | No | No | No | No | Yes |
| Stream Effects | No | No | No | No | No | Yes |
