...
| 1   | 35 LED Pixel Ring | OPTIONAL - For the inner cyclotron. The Arduino software supports other sizes of rings. 35 pixel ring is the default and recommended. | [Single Ring](https://a.co/d/fAmEV3r) or [Multi-Ring Kit](https://a.co/d/hJlh9vD) |
| 1   | 40 LED Pixel Ring | OPTIONAL - For the cyclotron lid, which MUST be exactly 40 pixels to fit properly. | [Multi-Ring Kit](https://a.co/d/40wMl8T) |
