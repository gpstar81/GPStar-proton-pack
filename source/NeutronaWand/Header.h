...
millisDelay ms_sync_failure; // Timer for considering the pack to have gone missing.
...
const unsigned int i_sync_failure_delay = 9750; // Delay before considering a proton pack disconnected.
