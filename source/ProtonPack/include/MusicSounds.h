...
enum sound_fx {
  ...
  S_VOICE_PROTON_PACK_GPSTAR_AUDIO_LED_ENABLED,
  S_VOICE_PROTON_PACK_GPSTAR_AUDIO_LED_DISABLED,
  S_VOICE_NEUTRONA_WAND_GPSTAR_AUDIO_LED_ENABLED,
  S_VOICE_NEUTRONA_WAND_GPSTAR_AUDIO_LED_DISABLED,
 ...
 */
const uint16_t i_last_effects_track = S_VOICE_PROTON_PACK_VOLUME_ADJUSTMENT;