...
String ap_ssid_prefix = "StreamEffects"; // This will be the base of the SSID name.
...
String ws_host = "192.168.1.2";  // WebSocket server IP
const uint16_t ws_port = 80;           // WebSocket server port
String ws_uri = "/ws";           // WebSocket URI
